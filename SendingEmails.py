...
#Reads from env.py, which contains environment variables (Not provided for privacy)
GOOGLE_CLIENT_ID = env.GOOGLE_CLIENT_ID
GOOGLE_CLIENT_SECRET = env.GOOGLE_CLIENT_SECRET
GOOGLE_REFRESH_TOKEN = env.GOOGLE_REFRESH_TOKEN #Set to None if you need to reset it
